...
import { Check, ChevronDown, CircleHelp, CirclePlus, ClipboardList, FolderKanban, LogOut, Menu, MoreHorizontal, PanelLeftClose, Plus, Search, Settings2, Sparkles, Trash2, UserPlus, Users, X } from 'lucide-react'
import './App.css'
...
function App() {
  ...
  async function loadWorkspaces() {
    try {
      ...
      if (data.workspaces?.length) selectWorkspace(data.workspaces[0]._id)
